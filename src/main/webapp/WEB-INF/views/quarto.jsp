  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav menu">
        ...
        <li class="active"><a href="/ProjetoJavaWeb/quarto">Quartos</a></li>
...
<h2 class="header-cat"> Listagem de Quartos </h2>
 <br><br>
  ...
  <table id="myTable" class="table table-bordered table-hover">
    ...
    <c:forEach var="quarto" items="${quartos}">
      <tr>
        ...
        <td><a href="/ProjetoJavaWeb/alterarQuarto?id=${quarto.id}"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;
        <a href="/ProjetoJavaWeb/removerQuarto?id=${quarto.id}"><span class="glyphicon glyphicon-trash"></span></a>
        </td>
      </tr>
    </c:forEach>
    </tbody>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h4>Cadastro de Quartos</h4>
         
      </div>
      <form method="post" action="cadastrarQuarto">
      <div class="modal-body">
         ...
         <div class="col-md-3 loco">
          <b>Andar:</b>
          <input type="text" class="form-control" name="andar" placeholder="">
          <br>
          <b>Número:</b>
...
<c:if test="${(edit == true) && (quarto != null)}">
 <!-- modal Edit -->
<div class="modal fade modal-edit" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h4>Alteração de Quartos</h4>
         
      </div>
      <form method="post" action="alterarQuarto">
      <div class="modal-body">
        
         <div class="container">
         
         <div class="col-md-3 loco">
         <input type="hidden" class="form-control" name="id" value="${quarto.id}" placeholder="">
          <b>Andar:</b>
          <input type="text" class="form-control" name="andar" value="${quarto.andar}" placeholder="">
          <br>
          <b>Número:</b>
          <input type="text" class="form-control" name="numero" value="${quarto.numero}" placeholder="">
          <br>
          ...
          <c:forEach var="categoria" items="${categorias}">
          	<c:if test="${quarto.categoria.id == categoria.id}">
...
<c:if test="${(edit == false) && (quarto != null)}">
  <!-- Modal REMOVE -->
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <div class="container">
             <h4>Você tem certeza que deseja excluir esse Quarto?</h4>
          </div>
          
        </div>
        <div class="modal-footer">
          <form method="post" action="removerQuarto">
          <input type="hidden" class="form-control" name="id" value="${quarto.id}" placeholder="">
